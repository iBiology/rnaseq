...
def main():
    ...
    fastp_parser.add_argument('fastq', help='Forward read (read 1) FASTQ file(s)', nargs='+', type=cmder.Files)
    ...
    map_parser.add_argument('fastq', help='Forward read (read 1) FASTQ file(s)', nargs='+', type=cmder.Files)
